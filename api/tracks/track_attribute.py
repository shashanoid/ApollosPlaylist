# Attribute documentation taken from:
...
# A class representing all the attributes that track can have. Each argument should be a TrackAttribute instance.
class TrackAttributes:
    def __init__(self, acousticness, danceability, energy, instrumentalness,
    ...
    def toJSON(self):
        return {
            'acousticness': self.acousticness.toJSON(),
            'danceability': self.danceability.toJSON(),
            'energy': self.energy.toJSON(),
            'instrumentalness': self.instrumentalness.toJSON(),
            'liveness': self.liveness.toJSON(),
            'loudness': self.loudness.toJSON(),
            'speechiness': self.speechiness.toJSON(),
            'tempo': self.tempo.toJSON(),
            'valence': self.valence.toJSON(),
        }
